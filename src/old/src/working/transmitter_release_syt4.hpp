// Time-stamp: <2017-09-01 11:00:31 anup>
// Units: All SI units - seconds, Volts, Ampere, Meters, Simenes, Farads

#ifndef TRANSMITTER_RELEASE_SYT4_HPP_INCLUDED	
#define TRANSMITTER_RELEASE_SYT4_HPP_INCLUDED

#include "data_types.hpp"
#include "random_number_generator.hpp"

namespace ar = astron::random;
namespace transmitter_release_syt4 {

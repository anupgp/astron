// Time-stamp: <2019-01-04 10:41:40 macbookair>
...
// Ref: heidelberger1994, crippa2006, hori2012
					      ...
					      stringmap valnames) 
{
  ...
  // variables[k0_index] = (variables[vkdoc_index] + variables[vfmob_index]) /(consts::Av * volume_cyt * 1000);
  // variables[f0_index] = (variables[vkdoc_index] + variables[vfmob_index]) /(consts::Av * volume_cyt * 1000);
